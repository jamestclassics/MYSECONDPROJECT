...
map.getView().fit([-787664.231267, 7107977.622572, -637639.376275, 7196740.213647], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Breastfeeding Friendly Locations County Louth</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (50 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Locations ( Breastfeeding Friendly ) James Treanor';
            }
